<template>
  <div>
      ...
      <img  v-else v-for="(url, index) in urlArr" class="small-img" :class="[{'more-img':showOne == true},{'img-i-b':alignRow == true}]" :style="{width:imgSize[0]+'px',height:imgSize[1]+'px'}"  @click="showImage(index)" :src="url">
